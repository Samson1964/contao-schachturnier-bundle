...
$GLOBALS['TL_LANG']['tl_schachturnier_partien']['round'] = array('Runde', 'Nummer der Runde');
...
$GLOBALS['TL_LANG']['tl_schachturnier_partien']['pgn_legend'] = 'PGN';
$GLOBALS['TL_LANG']['tl_schachturnier_partien']['pgn'] = array('PGN', 'PGN-Daten');

$GLOBALS['TL_LANG']['tl_schachturnier_partien']['publish_legend'] = 'Veröffentlichung';
